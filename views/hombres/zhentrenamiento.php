...
$this->title = 'Entrenamiento';
$this->params['breadcrumbs'][] = $this->title;
?>
<link href="css/carousel.css" rel="stylesheet">
<div class="site-about" style="float: left; margin: 0px 0px 0px 8%">
	<p>esto es zapatos hombre entrenamiento => Sitio en Construcci&oacute;n
	</p>
</div>
<!-- Carousel
...
<div id="myCarousel" class="carousel slide" data-ride="carousel"
	style="float: left; margin: 0px 0px 0px 6.7%">
	<!-- Indicators -->
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img class="first-slide" src="images/150306-start-zpump-sv-2.jpg"
				alt="First slide">
		</div>
		<div class="item">
			<img class="second-slide" src="images/150309-start-Essentials-sv.jpg"
				alt="Second slide">
		</div>
		<div class="item">
		...
		<div class="item">
			<img class="third-slide" src="images/gimlet-sv-NY.jpg"
				alt="Third slide">
		</div>
		<div class="item">
			<img class="third-slide"
				src="images/nike-for-her-JDI-weekend-1024x600.jpg" alt="Third slide">
		</div>
		<div class="item">
			<img class="third-slide"
		...
		<div class="item">
			<img class="third-slide" src="images/stadium-1024x600-2.png"
				alt="Third slide">
		</div>
		<div class="item">
			<img class="third-slide"
				src="images/ultra-boost-stadium-1024x600.png" alt="Third slide">
		</div>
	</div>
...
<div style="float: left; margin: 0px 0px 0px 8%">
  <div 
	style="float: left; margin: 0px 0px 0px 8%"		>
    <dl class="tips" cssname=""
				style="float: left; margin: 0px 0px 0px -18%"	>
      <table cellpadding="0" cellspacing="0" style="width: 20px;">
        <tbody>
          <tr>
            <td><img style="margin: 0% 0% 0% 8%;"
								src="images/150310-produktlist.jpg"
								alt="150219-productlist-sneakermania-1"></td>
          </tr>
          <tr>
            <td><div style="float: left; margin: 0px 0px 0px 8%;"> <span style="text-transform: uppercase; font-weight: bold;"></span> <br>
                <br>
                <table width="930px">
                  <tbody>
                    <tr>
